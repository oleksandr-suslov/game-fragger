document.addEventListener('DOMContentLoaded', () => {
    ...
    //write a function that move the Frog    
    function moveFrog(e) {
    ...
    // move the car rigth on a time loop
    function moveCarRight(carRight) {
        switch (true) {
            case casRight.classList.contains('c1'):
    ...
    // move the log rigth on a time loop
    ...
    startBtn.addEventListener('click', () => {
        if (timerId) {
            ...
            timerId = setInterval(movePirces, 1000)
